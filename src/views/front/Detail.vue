            ...
            <div class="mainCon">
                ...
                <div class="InfoWrap">
                    <div class="goodsDetail">
                        <h3 class="InfoName">{{ tableData.examName }}</h3>
                        <div class="priceArea">
                        ...
                        <div class="support">
                            <div class="supportArea">
                                ...
                                <div class="fixWidth">{{ tableData.classes }}</div>
                            </div>
                            <div class="supportArea">
                                <div class="title">发起部门</div>
                                <div class="fixWidth">{{ tableData.dept }}</div>
                            </div>
                            <div class="supportArea">
...
<script>
    export default {
        ...
        methods: {
            load() {
                this.request.get("/exam/detail/" + this.examName).then(res => {
                    if (res.code === '200') {
